...
void EditStudent(int StudentFoundIndex)
{
    ...
    while(!IsValidNumberOfCourse)
    {
        ...
        {
            printf(" Error: A Student can have maximum 6 and Minimum 2 number of courses.\n\n");
            IsValidNumberOfCourse = 0;
        }
        else
        {
...
void UserGuideline()
{
    ...
    printf(" A student can have maximum 4 courses and minimum 2 course.\n");
...
void AboutUs()
{
    ...
    printf("The Student Management System is a comprehensive software solution designed to streamline and automate various administrative tasks related to student information and records.");
    printf(" It provides a centralized platform for managing student data, including enrollment, attendance, grades, and personal details.");
    printf(" The system enhances communication between administrators, teachers, and parents, facilitating efficient information sharing and collaboration.");
    printf(" It offers modules for generating reports, tracking student progress, and scheduling activities, ultimately improving organizational efficiency and student outcomes.");
    printf(" With its user-friendly interface and robust features, the Student Management System is an essential tool for educational institutions seeking effective student administration.\n\n");
}
...
void ExitProject()
{
    system("cls");
    int i;
    char ThankYouSoMuch[100]     = "  Thank You So Much \n";
    char VisitUsForMoreInformation[100]   = " Visit Us For More Information \n";
    for(i=0; i<strlen(ThankYouSoMuch); i++)
    {
        printf("%c",ThankYouSoMuch[i]);
        Sleep(40);
    }
    for(i=0; i<strlen(VisitUsForMoreInformation); i++)
    {
        printf("%c",VisitUsForMoreInformation[i]);
        Sleep(40);
    }
    exit(0);
}
...
void DataSeed()
{
    ...
    strcpy(Students[0].Phone,"01123456789");
    ...
    strcpy(Students[1].Phone,"0123456789");
    ...
    strcpy(Students[2].Phone,"01123456789");
